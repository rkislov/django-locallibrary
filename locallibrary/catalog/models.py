...
class Genre(models.Model):
    name = models.CharField(max_length=200, help_text="Введите жанр книги (напр. Фантастика, Детектив, Роман)")
...
class Language(models.Model):
    name = models.CharField(max_length=200, help_text="Введите язык на котором написанна книга")
